...
Scheme
{
	...
	BaseSettings
	{
		...
		ReplayBrowser.BgColor								"100 100 100 255"
		ReplayBrowser.Details.TitleEdit.Carat.FgColor		"LightRed"
		ReplayBrowser.Button.ArmedBgColor					"ZHUD_Yellow"
		ReplayBrowser.Button.DepressedBgColor				"ZHUD_Yellow"
		ReplayBrowser.CollectionTitle.FgColor				"LightRed"
		ReplayBrowser.Warning.FgColor						"White"
		ReplayBrowser.ScrollBar.SliderButton.FgColor		"TransparentYellow"
		ReplayBrowser.Search.BgColor						"ZHUD_Shadow"
		ReplayBrowser.Search.FgColor						"ZHUD_White"
		
		Replay.RenderDialog.BgColor							"100 100 100 255"
		
		Econ.Dialog.BgColor									"Blank"
		Econ.Button.BgColor									"ZHUD_Shadow"
		Econ.Button.FgColor									"ZHUD_White"
		Econ.Button.ArmedBgColor							"ZHUD_Yellow"
		Econ.Button.ArmedFgColor							"ZHUD_White"
		Econ.Button.DepressedBgColor						"ZHUD_Yellow"
		Econ.Button.DepressedFgColor						"Black"
		
		Econ.Button.PresetDefaultColorFg					"ZHUD_White"
		Econ.Button.PresetArmedColorFg						"ZHUD_White"
		Econ.Button.PresetDepressedColorFg					"ZHUD_White"
		
		Econ.Button.PresetDefaultColorBg					"95 120 95 255"
		Econ.Button.PresetArmedColorBg						"95 120 95 255"
		Econ.Button.PresetDepressedColorBg					"ZHUD_Yellow"
		
		Border.Bright					"Blank"		// the lit side of a control
		Border.Dark						"Black"		// the dark/unlit side of a control
		Border.Selection				"Gray"			// the additional border color for displaying the default/selected button

		Button.TextColor				"ZHUD_White"
		Button.BgColor					"ZHUD_Shadow"
		Button.ArmedTextColor			"ZHUD_White"
		Button.ArmedBgColor				"ZHUD_Yellow"
		Button.SelectedTextColor		"ZHUD_White"
		Button.SelectedBgColor			"ZHUD_Yellow"
		Button.DepressedTextColor		"Black"
		Button.DepressedBgColor			"ZHUD_Yellow"

		CheckButton.TextColor			"ZHUD_White"
		CheckButton.SelectedTextColor	"ZHUD_White"
		CheckButton.BgColor				"TransparentBlack"
		CheckButton.Border1  			"ZHUD_White" 		// the left checkbutton border
		CheckButton.Border2  			"ZHUD_White"		// the right checkbutton border
		CheckButton.Check				"ZHUD_White"		// color of the check itself
		CheckButton.HighlightFgColor	"ZHUD_White"
		...
		Label.TextBrightColor			"ZHUD_White"
		...
		Menu.TextColor					"ZHUD_White"
		Menu.BgColor					"TransparentBlack"
		Menu.ArmedTextColor				"TanDark"
		Menu.ArmedBgColor				"ZHUD_White"
		Menu.TextInset					"6"
